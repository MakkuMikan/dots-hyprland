...
Item { // Bar content region
    ...
    RowLayout {
        ...
        RippleButton {
            id: notificationAreaButton

            Layout.alignment: Qt.AlignRight | Qt.AlignVCenter
            Layout.rightMargin: Appearance.rounding.screenRounding
            Layout.fillWidth: false

            implicitWidth: clockLayout.implicitWidth + 10 * 2
            implicitHeight: clockLayout.implicitHeight + 5 * 2
            ...
            toggled: GlobalStates.notificationAreaOpen
            ...
            onPressed: {
                GlobalStates.notificationAreaOpen = !GlobalStates.notificationAreaOpen;
            }
