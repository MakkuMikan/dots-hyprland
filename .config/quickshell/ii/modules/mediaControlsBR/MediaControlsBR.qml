...
Scope {
    ...
    GlobalShortcut {
        name: "mediaControlsBRToggle"
        description: "Toggles media controls on press"

        onPressed: {
            GlobalStates.mediaControlsBROpen = !GlobalStates.mediaControlsBROpen;
        }
    }
    GlobalShortcut {
        name: "mediaControlsBROpen"
        description: "Opens media controls on press"

        onPressed: {
            GlobalStates.mediaControlsBROpen = true;
        }
    }
    GlobalShortcut {
        name: "mediaControlsBRClose"
